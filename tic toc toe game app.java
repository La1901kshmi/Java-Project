...
public class Main
{
  ...
  public static void take_chance (String[]board, String player)
  {
    ...
    System.out.println ("enter no from 1 to 9");
  ...
  for (String piece:pieces)
	...
	if (board[0] == piece && board[1] == piece && board[2] == piece)
	  {
	    show_board (board);
	    System.out.println (piece + " " + "is Winner");
	    System.exit (0);
	  }


	if (board[4] == piece && board[5] == piece && board[6] == piece)
	  {
	    show_board (board);
	    System.out.println (piece + " " + "is Winner");
	    System.exit (0);
	...
	if (board[7] == piece && board[8] == piece && board[9] == piece)
	  {
	    show_board (board);
	    System.out.println (piece + " " + "is Winner");
	    System.exit (0);
